...
import { GuardrailsView } from './components/GuardrailsView.tsx';
...
function DashboardContent() {
  ...
  const handleShortcutTriggered = useCallback((tab: { id: string; label?: string; defaultLabel?: string; labelKey?: string }, keyNum: number) => {
    const displayLabel = (tab.labelKey ? t(tab.labelKey) : tab.defaultLabel) || tab.label || tab.id;
    setShortcutFeedback({ label: displayLabel, key: keyNum });
  ...
  // Global Keyboard Shortcut Handler: Alt + 1-8 toggles navigation tabs
